...
test::run_ansible() {
  ansible-playbook playbook.yml -i 'localhost' -e '{"install_python3": "true", "install_python2": "true", "pip3_to_install": ["awscli", "pylint", "mypy"], "pip2_to_install": ["pipenv"], "pip3_to_uninstall": ["pylint"], "pip2_to_uninstall": []}'
}
